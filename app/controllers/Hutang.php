...
class Hutang extends CI_Controller {
	...
	function index()
	{
		...
		$data['pemasok'] = $this->model_donatur->list_pemasok();
		$this->template->view_baru('hutang/add',$data);
	}
	...
	public function listht()
	{
		$data['judul'] 			= "Daftar Jurnal Hutang";
		...
		$data['jurnal'] 		= $this->model_hutang->list_jurnal($data['tanggal_awal'],
		$data['tanggal_akhir'], $data['no_jurnal'], $data['dikonfirmasi'])->result();
		$this->template->view_baru('hutang/daftar_jurnal', $data);
	}
