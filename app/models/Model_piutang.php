...
class Model_piutang extends CI_Model {
	...
	{
		$this->db->select('trs_jurnal.id_jurnal, SUM(trs_jurnal_detail.debet) AS debet, debitur, no_bukti, no_jurnal, tgl_jurnal, memo, total, dikonfirmasi, tgl_dibuat, tgl_diubah, kode_unik');
