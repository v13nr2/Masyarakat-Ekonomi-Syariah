<section class="content-header">
	<div class="row">
		<div class="col-md-3">
			<label class="label-header">Daftar Mita Kerja</label>
		</div>
		<div class="col-md-9">
			<div class="pull-right">
				<a href="<?=base_url('penyedia/add')?>" class="btn btn-sm btn-success"><img src="<?=base_url('assets/resources/add.png');?>" /> Tambah</a>
			</div>
		</div>
	 </div>
 </section>
		 ...
		 <div class="col-lg-12">
			...
			<div class="box box-primary">
				<div class="box-header">
					...
					<h3 class="box-title">Daftar Mitra Kerja</h3>
				</div>
				<div class="box-body">
					<table width="100%" id="dtcustomt" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?php foreach($query as $rowdata)
							{
								...
								<?php } echo '</td>';
								echo '<td align="center" width="10%">'; ?>
								<a href="<?=base_url()?>penyedia/ubah/<?=md5($rowdata->id)?>" title="Ubah Organisasi" data-toggle="tooltip"><img src="<?=base_url();?>assets/resources/edit.png" /></a>
								<?php echo '</td>'; echo '</tr>';
							}
