	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				 <a href="<?=base_url()?>aset"  ><img src="<?php echo base_url().'assets/images/icon/list2.png';?>" height="50px" title="Daftar Aset"></a>
			</div>
		</div>
	</div>
</div>
<div class="panel panel-default">
  <div class="panel-heading"><b>Tambah Aset</b></div>
  <div class="panel-body">
  <?php  if(validation_errors() != false) {echo alert_php2('', 'validate', validation_errors()); } ?>
  <?php echo $this->session->flashdata('pesan')?>
     <form action="<?=base_url()?>aset/insert" method="post" enctype="multipart/form-data">
       <table class="table table-striped">
         ...
         <tr>
          <td style="width:25%;">Tanggal Perolehan</td>
          <td>
            <div class="col-sm-10">
                <input type="text" name="tgl"  id="tgl" class="form-control" ></textarea>
            </div>
            </td>
         </tr>
          <tr>
          ...
          <td>
            <div class="col-sm-10">
                ...
                <input type="text" name="nobukti" class="form-control" value="">
				</div>
            </td>
         </tr> 
         <tr>
          ...
          <td>
            <div class="col-sm-10">
                <input type="text" name="nilai" id="nilai"  onkeyup="hitungSusut()" class="form-control required kanan" value="">
            </div>
            </td>
         </tr>
