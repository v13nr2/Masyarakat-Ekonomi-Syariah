...
<div class="row">
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				 <a href="<?=base_url()?>kas/listkas"  ><img src="<?php echo base_url().'assets/images/icon/list2.png';?>" height="50px" title="Ke Daftar Jurnal Kas"></a>
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">PEMASUKAN KAS / BANK</h3>
			</div>
			<div class="box-body">
				...
				<form class="form-horizontal" id="form" method="POST" >
					...
					<div class="col-md-4">
						<div class="form-group ui-widget">
							...
							<div class="col-sm-7">
								<select name="coa_debet"  class="form-control" required>
					...
					<div class="col-md-4" id="nobuktiDiv">
						<div class="form-group ui-widget">
							<label class="control-label col-sm-5" for="nama">No. Bukti</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="nobukti" name="nobukti" placeholder="Nomor Nota" >
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-sm-5" for="nama">Kategori</label>
							<div class="col-sm-7">
					...
					<div class="col-md-4" id="programDiv">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select name="program"   id="program" class="form-control selectnot">
								<option value="">-Pilih-</option>
								<?php
									foreach($program as $p){
										
										echo "<option $select value='$p->id_program'>$p->no_program</option>";
									}
									?>
								</select>
							</div>
					...
					<div class="col-md-4" id="proyekDiv">
						<div class="form-group">
							<label class="control-label col-sm-5" for="nama">Proyek</label>
							<div class="col-sm-7">
								<select name="proyek"  id="proyek" class="form-control selectnot">
								</select>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4" id="departemenDiv">
						<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-sm-5" for="nama">Ktg. Penyedia Dana</label>
							<div class="col-sm-7">
							<select id="Kategori_penyedia_dana"  name="kategori_penyedia_dana"  class="form-control">
								<option value="">-Pilih-</option>
								<?php
									foreach($kategori_penyedia_dana as $p){
										
										echo "<option $select value='$p->id'>$p->kategori_penyedia</option>";
									}
									?>
								</select>
							</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-sm-5" for="nama">Ktg.  Dana</label>
							<div class="col-sm-7">
							<select id="Kategori_dana"  name="kategori_dana"  class="form-control">
								<option value="">-Pilih-</option>
								<?php
									foreach($kategori_dana as $p){
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select name="penyedia"  id="penyedia" class="form-control">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-sm-5" for="nama">Penyaluran Dana</label>
							<div class="col-sm-7">
								<select name="penyaluran"  id="penyaluran" class="form-control">
								<option value="">-- Pilih Penyaluran --</option>
													<?php
													foreach($penyaluran as $p){
														if($p->nama_penyaluran_dana==$nama_penyaluran_dana){
															$select = "";
														}else{
															$select = "";
														}
														echo "<option $select value='$p->id'>$p->nama_penyaluran_dana</option>";
													}
													?>
								</select>
				</div>
...
function inputnilai(x){
	$('#kredit_'+x).val(formatCurrency($('#kredit_'+x).val()));
}
...
<script type="text/javascript">
	...
	$("#form").submit(function(e){
		...
		while( ( inputj = document.getElementById( 'kredit_'+j ) ) !== null ) {
			totalKredit += parseInt( (clearNum(inputj.value)) );
			++j;
		}
		//alert( totalKredit );
		 
			//oke = confirm("Akan menjurnal sejumlah "+totalKredit+" ?");
			oke = confirm("Akan menjurnal sejumlah  ?");
			if(oke == true){
					
				e.preventDefault();
				$.ajax({
					type:'POST',
					url:'<?php echo base_url('/kas/simpan')?>',
					dataType: "json",
					data:$(this).serialize(),
	...
	function tmp(id){
		...
		html_out += "<td><input type='text' class='form-control kanan' id='kredit_"+id+"'  onkeyup='inputnilai("+id+")'   name='txt_kredit[]' placeholder='Kredit' value='0'/></td>";
