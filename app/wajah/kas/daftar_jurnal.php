	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				 <a href="<?=base_url()?>kas"  ><img src="<?php echo base_url().'assets/images/icon/add.png';?>" height="50px" title="Tambah Jurnal Kas"></a>
			</div>
		</div>
	</div>
</div>
			...
			<form autocomplete="off" method="GET">
				<div class="box box-primary">
					<div class="box-header">
						...
						<h3 class="box-title">Daftar Jurnal KAS Masuk</h3>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-lg-12">
