	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="pull-right">
				<a href="<?=base_url('kategori_dana/tambah')?>" class="btn btn-sm btn-success"><img src="<?=base_url('assets/resources/add.png');?>" /> Tambah</a>
			</div>
		</div>
	 </div>
 </section>
					...
					<table width="100%" id="dtcustomt" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?php foreach ($kategori_dana as $b)
							{
								...
								<a href="<?=base_url()?>kategori_dana/ubah/<?=md5($b->id)?>" title="Ubah kategori_dana" data-toggle="tooltip"><img src="<?=base_url();?>assets/resources/edit.png" /></a>
								<?php echo '</td>'; echo '</tr>';
							}
							?>
						</tbody>
