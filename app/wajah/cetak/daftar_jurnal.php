						...
						<div class="row">
							<div class="col-lg-12">
								<div class="col-lg-4 col-xs-10">
									...
									<a href="<?php echo site_url('cetak');?>" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i> Reset</a>
								</div>
							</div>
						</div>
					</div>
								...
								<thead>
									...
									<tbody>
										<?php foreach ($jurnal as $b)
										{
											...
											echo '<a data-toggle="tooltip" href="'.base_url('cetak/detail/'.$b->kode_unik).'" title="Detail '.$b->no_jurnal.'" class="btn btn-success btn-xs">Cetak</a>&nbsp;';
											?>
											<?php echo '</td>'; echo '</tr>';
										} ?>
									</tbody>
