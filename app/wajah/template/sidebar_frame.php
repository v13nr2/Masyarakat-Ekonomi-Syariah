		...
		<ul class="sidebar-menu">
			...
			<li <?php if($menu_a=="master_data") echo 'class="active"'; ?> class="treeview">
				...
				<ul class="treeview-menu">
				    ...
				    <li <?php if($menu_a=="bank") echo 'class="active"'; ?>><a href="<?=base_url('bank')?>"><i class="fa fa-circle-o"></i> <span class="kunci">Bank	</span></a></li>
			...
			<li <?php if($menu_a=="laporan") echo 'class="active"'; ?> class="treeview">
				...
				<ul class="treeview-menu">
				    ...
				    <li <?php if($menu_a=="penayluran_dana") echo 'class="active"'; ?> class="treeview">
						<a href="#"><i class="fa fa-list"></i> <span>Laporan Utama</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
						<ul class="treeview-menu">
							<li <?php if($menu_a=="kegiatan") echo 'class="active"'; ?>><a href="<?=base_url()?>kegiatan"><i class="fa fa-circle-o"></i> <span class="kunci">Laporan Aktivitas</span></a></li>
				            <li <?php if($menu_a=="kegiatan") echo 'class="active"'; ?>><a href="<?=base_url()?>kegiatan"><i class="fa fa-circle-o"></i> <span class="kunci">Perubahan Aset Netto</span></a></li>
				            <li <?php if($menu_a=="kegiatan") echo 'class="active"'; ?>><a href="<?=base_url()?>kegiatan"><i class="fa fa-circle-o"></i> <span class="kunci">Posisi Keuangan</span></a></li>
				        </ul>
					</li>
				</ul>
			</li>
