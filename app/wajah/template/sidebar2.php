            ...
            <section class="sidebar">
                <ul class="nav side-menu" style="width: 230px; height:500px; overflow: auto">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li <?php if ($menu_a == "master_data") echo 'class="active"'; ?> class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li <?php if ($menu_a == "penyaluran_dana_jenis") echo 'class="active"'; ?>><a href="<?= base_url('penyaluran_dana_jenis') ?>"><i class="fa fa-circle-o"></i> <span class="kunci">Jenis Penyaluran Dana</span></a></li>
                                </ul>
                            </li>
                    ...
                    <li <?php if ($menu_a == "organisasi") echo 'class="active"'; ?> class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li <?php if ($menu_a == "organias") echo 'class="active"'; ?>><a href="<?= base_url('upload/ubah/c4ca4238a0b923820dcc509a6f75849b') ?>"><i class="fa fa-circle-o"></i> <span class="kunci">Kepengurusan   </span></a></li>
                            ...
                            <li <?php if ($menu_a == "penayluran_dana") echo 'class="active"'; ?> class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li <?php if ($menu_a == "penerimaan_dana") echo 'class="active"'; ?>><a href="<?= base_url('penerimaan_dana') ?>"><i class="fa fa-circle-o"></i> <span class="kunci">Penerimaan Dana</span></a></li>
                                    <li <?php if ($menu_a == "penyaluran_dana") echo 'class="active"'; ?>><a href="<?= base_url('penyaluran_dana') ?>"><i class="fa fa-circle-o"></i> <span class="kunci">Penyaluran Dana</span></a></li>
                                </ul>
                            </li>
                            <li <?php if ($menu_a == "penayluran_dana") echo 'class="active"'; ?> class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li <?php if ($menu_a == "master_data") echo 'class="active"'; ?> class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li <?php if ($menu_a == "cetak") echo 'class="active"'; ?>><a href="<?= base_url('blank') ?>"><i class="fa fa-circle-o"></i> <span class="kunci">Faktur</span></a></li>
