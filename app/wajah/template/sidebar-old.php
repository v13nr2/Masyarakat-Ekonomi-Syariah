                ...
                <ul  class="nav side-menu" style="width: 230px; height:500px; overflow: auto">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li <?php if ($menu_a == "master_data") echo 'class="active"'; ?> class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li <?php if ($menu_c == "tutupbuku") echo 'class="active"'; ?>><a href="<?= base_url('tutupbuku') ?>"><i class="fa fa-circle-o"></i> <span class="kunci">Periode Tahun Buku</span></a></li>
                    ...
                    <li <?php if ($menu_a == "kasir") echo 'class="active"'; ?> class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li <?php if ($menu_a == "gajikaryawan" && $menu_b != "gajikaryawan") echo 'class="active"'; ?>><a href="<?= base_url('gajikaryawan') ?>"><i class="fa fa-files-o"></i> <span class="kunci">Gaji karyawan</span></a></li>
                            <li <?php if ($menu_a == "penayluran_dana") echo 'class="active"'; ?> class="treeview">
