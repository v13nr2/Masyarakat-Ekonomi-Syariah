	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<form id="s" class="form-horizontal" autocomplete="off" method="post" action="<?=base_url()?>pinjaman/tambah">
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type="text" class="form-control" data-validetta="required" value="<?php echo date('Y-m-d');?>" name="tanggal_pinjaman" maxlength="50" id="tanggal_pinjaman" value="" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-3">Jumlah Pinjaman</label>
							<div class="col-lg-4">
								<input type="text" class="form-control" data-validetta="required" name="jumlah_pinjaman" maxlength="50" id="jumlah_pinjaman" value="" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-4">
								<select name="status_pinjaman" class="form-control" >
										...
										<option value="Baru">Pinjaman Baru</option>
