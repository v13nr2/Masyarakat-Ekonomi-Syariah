...
<section class="content-header">
	<div class="row">
		<div class="col-md-5">
			<label class="label-header">Tambah Daftar Piutang</label>
		</div>
	</div>
</section>
	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				 <a href="<?=base_url()?>piutang/listjp"  class="btn btn-primary" type="button" >Ke Daftar Piutang</a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="box">
			...
			<div class="box-body">
				...
				<form class="form-horizontal" id="form" method="POST" >
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-3" for="nama">Penyedia</label>
							<div class="col-sm-6">
								 <select name="debitur"  id="debitur" class="form-control">
	...
	$("#form").submit(function(e){
		...
		if(totalDebet!=totalKredit){
			...
			return false;
				...
				$.ajax({
					type:'POST',
					url:'<?php echo base_url('/piutang/simpan')?>',
					dataType: "json",
					data:$(this).serialize(),
