		...
		<div class="col-md-12">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<?=base_url('proyek/kasmasuk');?>?id=<?php echo $_GET["id"];?>&idProyek=<?php echo $_GET["idProyek"];?>">KAS MASUK</a></li>
	...
	$("#form").submit(function(e){
		...
		//alert( totalKredit );
			...
			if(oke == true){
				...
				$.ajax({
					type:'POST',
					url:'<?php echo base_url('/proyek/simpankasmasuk')?>',
					dataType: "json",
					data:$(this).serialize(),
