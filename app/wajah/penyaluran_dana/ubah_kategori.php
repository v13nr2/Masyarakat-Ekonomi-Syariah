	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<form id="s" class="form-horizontal" autocomplete="off" method="post" action="<?=base_url()?>penyaluran_dana/ubah/<?=$this->uri->segment(3)?>">
						<div class="form-group">
							<label class="control-label col-lg-2">Nama Penyaluran</label>
							<div class="col-lg-4">
								<input type="text" class="form-control" data-validetta="required" name="nama_penyaluran_dana" maxlength="50" id="nama" value="<?=$kategori_dana["nama_penyaluran_dana"]?>" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-2">Kategori Penyaluran</label>
							<div class="col-lg-4">
									<?php echo '<select class="form-control selectnot" name="kategori_penyaluran_dana">
												<option value="">-Pilih-</option>';
															foreach ($jenis as $a) {
																$ss = "";
																if($a->id==$kategori_dana["kategori_penyaluran_dana"])
																{$ss='selected="selected"';}
																
																echo '<option value="'. $a->id .'" '.$ss.' >'. $a->jenis_penyaluran_dana .'</option>';
															}
															echo '</select>';
															?>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type="text" class="form-control" data-validetta="required" name="nilai" maxlength="50" id="nama" value="<?=$kategori_dana["nilai"]?>" />
							</div>
						</div>
						<div class="form-group">
