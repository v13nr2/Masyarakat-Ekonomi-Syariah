	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				 <a href="<?=base_url()?>kaskeluar/listkas"  ><img src="<?php echo base_url().'assets/images/icon/list2.png';?>" height="50px" title="Ke Daftar Jurnal Kas"></a>
			</div>
		</div>
	</div>
</div>
	...
	$("#form").submit(function(e){
		...
		//alert( totalKredit );
			...
			if(oke == true){
				...
				$.ajax({
					type:'POST',
					url:'<?php echo base_url('/kaskeluar/simpan')?>',
					dataType: "json",
					data:$(this).serialize(),
